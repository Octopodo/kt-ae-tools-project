...
// Remove using path
KT_Project.remove.item("//CompositionToDelete");
...
// Remove by path
KT_Project.remove.comp("//Sequences//Scene_01");
```
...
// Remove by path
KT_Project.remove.folder("//Unused//OldComps");
```
...
const pathsToRemove = ["//Comps//Unused_01", "//Comps//Unused_02", "//Assets//OldFootage"];
